...
<body>
    <div id="registerForm" class="reg">
        <div class=regcontainer>
            ...
            <div>
                <form id="myForm" method="POST" action="{{ route('registration-submit') }}"
                    ...
                    <div>
                        ...
                        <div class="password-input-container">
                            <input type="password" name="password" id="password" type="text" required minlength="8"
                    ...
                    <div>
                        ...
                        <div class="password-input-container">
                            <input type="password" id="confirmPassword" name="confirmPassword" required minlength="8"
                                onchange = "checkPassword()">
                            <div id="toggleConfPassword" class="eye-icon"
                                onclick="togglePasswordVisibility('confirmPassword', 'toggleConfPassword')">
                                <img src="public/logos/eyeclosed.svg" alt="Toggle Password Visibility">
                            </div>
                        </div>
