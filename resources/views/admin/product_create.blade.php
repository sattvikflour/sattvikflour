                    ...
                    <div class="card w-100">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="prod-original-price"
                                    name="prod-original-price" step="0.01" required>
                                <small id="prod-original-price-error" class="text-danger" style="display: none;">This field
                                    is required</small>
                            ...
                            <div class="form-group">
                                ...
                                <small id="prod-description-error" class="text-danger" style="display: none;">This field
                                    is required</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" id="prod-type-label-container">
                                ...
                                <small id="prod-type-label-error" class="text-danger" style="display: none;">This field
                                    is required</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" id="packaging-opts-label-container">
                                ...
                                <small id="packaging-opts-label-error" class="text-danger" style="display: none;">This
