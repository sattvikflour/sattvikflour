    ...
    <script>
        $(document).ready(function() {
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full) {
                            let actions = '';
                            actions +=
                                `<a href="${full['edit']}" class="btn btn-sm btn-info m-1" title="Edit Product"> Edit </a>`;
                            actions +=
                                `<a href="${full['delete']}" class="action-delete btn btn-sm btn-danger m-1" data-id=${full['id']}>Delete</a>`;
            ...
            $('#category-dropdown').on('change', function() {
                dataListView.ajax.url("{{ URL::to('ajax-get-products') }}?category_id=" + $(this).val())
                    .load();
            });
        });
    </script>
